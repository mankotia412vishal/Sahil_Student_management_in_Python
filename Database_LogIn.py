...
db = mysql.connector.connect(host="localhost",user="root",passwd="Sahil2002@",database="project_dbmss")
mycur = db.cursor()
...
def main_screen():
    ...
    Label(root,text="Welcome to Sahil Bhat",font="bold",bg="grey",fg="black",width=300).pack()
    ...
    Label(root,text="").pack()
    Label(root,text="").pack()
    Label(root,text="Developed By Sahil").pack()
